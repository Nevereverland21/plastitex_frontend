  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 bg-white">
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <div>
          <h2 className="text-lg font-bold text-brand-navy">No se pudo cargar el catálogo</h2>
          <p className="text-sm text-gray-400 mt-1">
            Hubo un problema al obtener los productos. Intenta de nuevo en unos segundos.
          </p>
        </div>
        <button
          onClick={reset}
